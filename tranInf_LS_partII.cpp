...
#include <math.h>
using namespace std;
#define Q 249    // max test total number of qubits = Q - 1
...
int main() {
    ...
    for(int epInd = 0; epInd < TestNep; ++epInd) {
        ...
        // output to a txt file
        string fileName, fn1, fn2, fn3;
        fn1 = "/Users/zhanyuan/Desktop/data/totInfid2DSLTest3";
        fn2 = to_string(Q);
        fn3 = ".txt";
        fileName = fn1 + fn2 + fn3;
        ofstream fout(fileName);
    ...
    //    fn1Q = "/Users/zhanyuan/Desktop/data/totInfid2DSL";
    //    fn2Q = to_string(Q);
    //    fn3Q = ".txt";
